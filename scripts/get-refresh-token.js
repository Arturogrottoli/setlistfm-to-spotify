...
if (!clientId || !clientSecret) {
  ...
  console.error(
    "Agrega estas variables de entorno antes de ejecutar este script"
  );
  process.exit(1);
}
...
console.log("Paso 3: Serás redirigido a https://example.com/callback?code=XXX");
console.log(
  'Paso 4: Copia el código de la URL (la parte después de "code=") y pégalo aquí\n'
);
